      ...
      if (isSecondNumber) {
        if (secondNumber.toString().split(".").length > 1) {
          secondNumber = parseFloat(
            secondNumber.toString().split(".")[0] +
              "." +
              secondNumber.toString().split(".")[1] +
              number
          );
        } else {
          secondNumber = parseFloat(
            secondNumber.toString().split(".")[0] + "." + number
          );
        }
        ...
        if (firstNumber.toString().split(".").length > 1) {
          firstNumber = parseFloat(
            firstNumber.toString().split(".")[0] +
              "." +
              firstNumber.toString().split(".")[1] +
              number
          );
        } else {
          firstNumber = parseFloat(
            firstNumber.toString().split(".")[0] + "." + number
          );
        }
        outputToScreen(firstNumber);
      }
